...
<body>
    <form id="form1" runat="server">
        <div class="title">
            ...
            <div>
                <a href="MainFrame.aspx" class="a">
                    <input type="button" value="返回主页" class="topButton" />
                </a>
                <a href="ManagerLogin.aspx" class="a">
                    <input type="button" value="后台入口" class="topButton" />
                </a>
                <a href="register.aspx" class="a">
                    <input type="button" value="注册" class="topButton" />
                </a>
            </div>
        </div>
        <div class="panel">
